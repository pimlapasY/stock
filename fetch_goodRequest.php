...
$sql = "SELECT * FROM (SELECT *, ROW_NUMBER() OVER (PARTITION BY r_reqno ORDER BY r_req_date DESC) as row_num FROM request WHERE r_reqno LIKE :search) AS temp_table WHERE row_num = 1 ORDER BY r_req_date DESC LIMIT :limit OFFSET :offset";
