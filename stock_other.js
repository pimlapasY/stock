        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                details.forEach(function (detail) {
                    ...
                    if (statusBtn == 1) {
                        $('#priceLabel1').text('Sale Price');
                        $('#priceLabel2').text('Sale Price (Vat%)');
                        $('#priceLabel3').text('Total Sale (Vat%)');

                        var vat = parseFloat((detail.p_sale_price * detail.p_vat) / 100);
                        const totalPrice = detail.qty * (parseFloat(detail.p_sale_price) + vat);
                        ...
                        $('#priceLabel1').text('Cost Price');
                        $('#priceLabel2').text('Cost Price (Vat%)');
                        $('#priceLabel3').text('Total Cost (Vat%)');

                        var vat = parseFloat((detail.p_cost_price * detail.p_vat) / 100);
                        const totalPrice = detail.qty * (parseFloat(detail.p_cost_price) + vat);
                        allTotal += totalPrice; // Sum the total prices
