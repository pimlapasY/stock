...
<body>
    ...
    <div class="table-responsive">
        <div class=" container-fluid pt-5 col-12">
                        ...
                        $.ajax({
                            ...
                            success: function(response) {
                                ...
                                Swal.fire({
                                    ...
                                    // Call a function after closing the SweetAlert
                                    openEditModal(prID);
                                    $('#closeModalButton').prop('disabled',
                                        false)
                                    // Optionally reload the page or perform additional actions
                                    // location.reload();
                    ...
                    success: function(response) {
                        ...
                        if (jsonResponse.hasOwnProperty('success')) {
                            ...
                            Swal.fire({
                                ...
                                $('#alertExchange').removeClass('alert-danger')
                                    .addClass(
                                        'alert-success').html(
                            ...
                            Swal.fire({
                                ...
                                $('#alertExchange').removeClass('alert-success')
                                    .addClass(
        ...
        function openEditModal(prID) {
            ...
            $.ajax({
                ...
                success: function(data) {
                    var prStatus = '';
                    $('#editModalLabel').html('<i class="fa-solid fa-paste"></i> PR Management: ' + data
                        .pr_code);
