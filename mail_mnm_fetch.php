...
if (isset($_POST['store'])) {
    ...
    try {
        ...
        $sql .= " ORDER BY pr.pr_mail DESC, pr.pr_download DESC,  pr.pr_code DESC, pr.pr_date_add DESC";
        ...
        if (empty($products)) {
            ...
            foreach ($products as $index => $product) {
                ...
                echo '<td class="text-center"><span class="badge badge-warning"><i class="fa-solid fa-envelope"></i> ' . $product['pr_mail'] . '</span>
                <span class="badge badge-primary"><i class="fa-solid fa-paperclip"></i> ' . $product['pr_download'] . '</span> </td>';
                echo '<td> <span class="badge badge-success">' . $product['pr_code'] . '</span></td>';
