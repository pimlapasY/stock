        ...
        <div class="container-fluid mt-5 pt-5 col-12">
            ...
            <div class="mb-3 d-flex">
                ...
                <div class="col-9 d-flex">
                    ...
                    <input type="search" id="option1" list="product_option1" class="s-input form-control me-2"
                        placeholder="กรอกตัวเลือก1 (ถ้ามี)" disabled>
                    <datalist id="product_option1">
                        <!--  -->
                    </datalist>

                    <input type="search" id="option2" list="product_option2" class="s-input form-control me-2"
                        placeholder="กรอกตัวเลือก2 (ถ้ามี)" disabled>
                    <datalist id="product_option2">
                        <!--  -->
                    </datalist>

                    <input type="search" id="option3" list="product_option3" class="s-input form-control"
            ...
            <div class="">
                <table id="productTable" class="table table-sm table-bordered table-hover">
                    ...
                    <tbody class="table-group-divider table-divider-color" id="tableBody">
