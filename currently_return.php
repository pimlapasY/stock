...
/////////////////////////////////////////////////////////////////////////////////////////////
  ...
  $sql_stockin = "INSERT INTO stockin (i_no, i_product_id, i_mg_code, i_qty, i_product_code, i_status, i_username, i_total_price,	i_current_qty,  i_date_add) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, now())";
  $stmt_stockin = $pdo->prepare($sql_stockin);

  // Prepare the update statement for stock table (outside the loop)
  $sql_update_stock = "UPDATE stock SET s_qty = s_qty + ? WHERE s_product_id = ?";
