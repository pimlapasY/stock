...
<head>
    ...
    function confirmSubmit() {
        ...
        var form = document.getElementById("registerSupForm");
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                $.ajax({
                    ...
                    type: 'POST',
                    data: $('#registerSupForm').serialize(), // Serialize form data
                    success: function(response) {
                        ...
                        Swal.fire({
                            ...
                            window.location.href = 'list.php?page=register_supplier';
                        });
                    },
