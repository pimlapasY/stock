        ...
        <div class="container-fluid pt-5 col-12 mt-5">
            ...
            <div class="d-flex align-self-end  align-items-center mb-2">
                ...
                if ($currentDay >= 18 && $currentDay <= 20) { ?>
                    <a class="btn btn-outline-success" style="white-space: nowrap;" id="purchaseSelected">
                        <i class="fa-solid fa-circle-check"></i> 1 Purchase
                    </a>&nbsp;
                <?php } else { ?>
                    <button class="btn btn-success" style="white-space: nowrap;" id="purchaseSelected" disabled>
                        <i class="fa-solid fa-circle-check"></i> 1 Purchase
                    </button>&nbsp;
                <?php } ?>

                <a class="btn btn-outline-warning" style="white-space: nowrap;" id="deliveredSelected"><i
                        class="fa-solid fa-truck-ramp-box"></i>
                    2 Delivered</a>&nbsp;
                <a class="btn btn-outline-info" style="white-space: nowrap;" id="stockinSelected"><i
                        class="fa-solid fa-boxes-stacked"></i>
                    3 Stockin</a>&nbsp;

                <select class="form-select badge-danger" id="prStatusSelected" name="prStatusSelected">
                    <option value="all">All status</option>
                    <option value="99">- Pending</option>
                    <option value="1">- Issue PR/PO</option>
                    <option value="2">- Delivered</option>
                </select>&nbsp;
                <select class="form-select badge-danger" id="paymentStatus" name="paymentStatus">
                        ...
                        <div class="col-md-6">
                            <form id="editForm">
                                <div class="mb-3">
                                    ...
                                    <input type="search" class="form-control" id="size" list="product_size" disabled>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="search" class="form-control" id="hand" list="product_hand" disabled>
