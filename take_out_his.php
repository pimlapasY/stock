    ...
    <div class="table-responsive">
        <div class="container-fluid pt-5 mt-5  col-12">
            <div class="d-flex justify-content-start p-2">
                <h1 id="head_list">
                    <?php
                    echo ' <i class="fa-solid fa-laptop-medical fa-lg"></i> ' . 'Take Out';
                    ?>
                </h1>
            </div>
            <hr>
            ...
            <div class="">
                <table class="table table-hover mx-auto table-sm">
                    <thead class="table-primary" style="text-transform: uppercase;">
                        <tr>
                            <th>#</th>
                            <th><?php echo 'out date'; ?></th>
