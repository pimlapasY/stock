...
if (isset($_POST['store'])) {
    ...
    try {
        ...
        if ($pr_status == 1) {
            ...
            $sql .= " AND (pr.pr_status = 2 OR pr.pr_status IS NULL)";
        }
        ...
        $classColor = ($product['pr_status'] == '1' && $product['pr_exchange'] == null) ? 'success' :
          (($product['pr_status'] == '2' && $product['pr_exchange'] == null) ? 'warning' : (($product['pr_status'] == '3' && $product['pr_exchange'] == null) ? 'info' : 'secondary' ));
