...
<?php include 'new_update_modal.html' ?>
<nav class="navbar p-0 navbar-expand-lg navbar-light bg-light fixed-top nav-color-top">
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse justify-content-end align-content-center" id="navbarNavDropdown">
            <!-- <button type="button" class="btn btn-primary me-3" data-bs-toggle="modal" data-bs-target="#modalNewUpdate">
                มีอะไรใหม่ <span class="badge bg-secondary">6</span>
            </button> -->
...
<div class="d-flex align-items-center" style="height: 100vh; position:fixed">
    <button style="height: 20vh;" class="btn btn-secondary" type="button" data-bs-toggle="offcanvas"
        ...
        <div class="col-12">
            <div class="container-fluid mx-auto h-100 nav-custom">
                ...
                <div id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav">
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu <?php echo ($currentPage == 'stock_list.php' || $currentPage == 'stock_samt.php' || $currentPage == 'stock_other.php') ? 'show' : ''; ?>"
                                ...
                                <li>
                                    <a class="dropdown-item <?php echo ($currentPage == 'stock_list.php') ? 'active' : ''; ?>"
                                        href="stock_list.php"><?php echo $all ?></a>
                                </li>
                                <li>
                                    <a class="dropdown-item <?php echo ($currentPage == 'stock_samt.php') ? 'active' : ''; ?>"
                                        href="stock_samt.php">SAMT</a>
                                </li>
                                <li>
                                    <a class="dropdown-item <?php echo ($currentPage == 'stock_other.php') ? 'active' : ''; ?>"
                                        href="stock_other.php"><?php echo $other ?></a>
                                </li>
                            </ul>
                        </li>
                    </ul>
                    ...
                    <ul class="navbar-nav">
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu <?php echo ($currentPage == 'currently_taken.php' || $currentPage == 'currently_samt.php' || $currentPage == 'currently_other.php') ? 'show' : ''; ?>"
                                ...
                                <li>
                                    <a class="dropdown-item  <?php echo ($currentPage == 'currently_taken.php') ? 'active' : ''; ?>"
                                        href="currently_taken.php"><?php echo $all ?></a>
                                </li>
                                <li>
                                    <a class="dropdown-item <?php echo ($currentPage == 'currently_samt.php') ? 'active' : ''; ?>"
                                        href="currently_samt.php">SAMT</a>
                                </li>
                                <li>
                                    <a class="dropdown-item <?php echo ($currentPage == 'currently_other.php') ? 'active' : ''; ?>"
                                        href="currently_other.php"><?php echo $other ?></a>
                                </li>
                            </ul>
                        </li>
                    </ul>
                            ...
                            <ul class="dropdown-menu <?php echo ($currentPage == 'pr_create.php' || $currentPage == 'pr_management.php' || $currentPage == 'pr_history.php' || $currentPage == 'pr_exchange.php') ? 'show' : ''; ?>"
                                ...
                                <li>
                                    <a class="dropdown-item <?php echo ($currentPage == 'pr_create.php') ? 'active' : ''; ?>"
                                        href="pr_create.php"><?php echo $pr_add ?>
                                    </a>
                                </li>
                                <li>
                                    <a class="dropdown-item <?php echo ($currentPage == 'pr_management.php') ? 'active' : ''; ?>"
                                        href="pr_management.php"><?php echo $pr_manage ?>
                                    </a>
                                </li>
                                <li>
                                    <a class="dropdown-item <?php echo ($currentPage == 'pr_exchange.php') ? 'active' : ''; ?>"
                                        href="pr_exchange.php">PR Exchange
                                    </a>
                                </li>
                                <li>
                                    <a class="dropdown-item <?php echo ($currentPage == 'pr_history.php') ? 'active' : ''; ?>"
                                        href="pr_history.php"><?php echo 'PR History' ?>
                                    </a>
                                </li>
                            </ul>
                        </li>
                    ...
                    <ul class="navbar-nav">
                        <li class="nav-item">
                            <a class="nav-link <?php echo ($currentPage == 'mail_management.php') ? 'active font-weight-bold text-primary' : ''; ?>"
                                href="mail_management.php" id="navbar11" role="button">
                                <i class="fa-solid fa-envelopes-bulk"></i>
                                <?php echo 'mail management' ?>
                            </a>
                        </li>
                    </ul>
                    <!-- 
            <ul class="navbar-nav">
                <li class="nav-item">
                    ...
                    <ul class="navbar-nav">
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu <?php echo ($currentPage == 'stock_in.php' || $currentPage == 'stock_in_his.php') ? 'show' : ''; ?>"
                                ...
                                <li>
                                    <a class="dropdown-item <?php echo ($currentPage == 'stock_in.php') ? 'active' : ''; ?>"
                                        href="stock_in.php"><?php echo $stock_in ?></a>
                                </li>
                                <li>
                                    <a class="dropdown-item <?php echo ($currentPage == 'stock_in_his.php') ? 'active' : ''; ?>"
                                        href="stock_in_his.php"><?php echo 'StockIn History' ?></a>
                                </li>
                            </ul>
                        </li>
                    </ul>
                    <ul class="navbar-nav">
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle <?php echo ($currentPage == 'stock_out.php' || $currentPage == 'his_all.php' || $currentPage == 'take_out_his.php') ? 'active font-weight-bold text-primary' : ''; ?>"
                            ...
                            <ul class="dropdown-menu <?php echo ($currentPage == 'stock_out.php' || $currentPage == 'his_all.php' || $currentPage == 'take_out_his.php') ? 'show' : ''; ?>"
                                id="dropdownMenu7" aria-labelledby="navbar7">
                                <li>
                                    <a class="dropdown-item <?php echo ($currentPage == 'stock_out.php') ? 'active' : ''; ?>"
                                        href="stock_out.php"><?php echo $stock_out ?></a>
                                </li>
                                <li>
                                    <a class="dropdown-item <?php echo ($currentPage == 'his_all.php') ? 'active' : ''; ?>"
                                        href="his_all.php"> <?php echo $history . ' [Stock out]' ?></a>
                                </li>
                                <li>
                                    <a class="dropdown-item <?php echo ($currentPage == 'take_out_his.php') ? 'active' : ''; ?>"
                                        href="take_out_his.php">
                                        <?php echo $history . ' [Take out]' ?>
                                    </a>
                                </li>
                            </ul>
                        </li>
