    ...
    if (isset($_POST['previewData'])) {
        ...
        foreach ($_POST['previewData'] as $product) {
          ...
          VALUES (:no_code, :id, :code, :qty, :current_qty, :usercode, :reason,  :datevalue, :memo, now())";
                ...
                // คำนวณ total cost
                $totalCost_cal = (float)$row_product['p_cost_price'] * (int)$product['s_qty'];
                ...
                $stmt_insert_pr->bindParam(':qty', $product['s_qty'], PDO::PARAM_INT);
                ...
                $stmt_insert_pr->bindParam(':totalCost', $totalCost_cal, PDO::PARAM_STR);
